        ...
        if (file_exists(base_path('routes/web.php'))) {
            ...
            */
            ...
            $menuItem = MenuItem::firstOrNew([
                'menu_id' => $menu->id,
                'title'   => 'fa-facebook',
                'url'     => 'https://www.facebook.com/kingwanyama',
                'route'   => null,
            ]);
            if (!$menuItem->exists) {
                $menuItem->fill([
            ...
            $menuItem = MenuItem::firstOrNew([
                'menu_id' => $menu->id,
                'title'   => 'fa-youtube',
                'url'     => 'https://www.youtube.com/channel/UCs6ovXmbr87BzDU642LhHDA',
                'route'   => null,
            ]);
            if (!$menuItem->exists) {
                $menuItem->fill([
            ...
            $menuItem = MenuItem::firstOrNew([
                'menu_id' => $menu->id,
                'title'   => 'fa-github',
                'url'     => 'https://github.com/bsakari?tab=repositories',
                'route'   => null,
            ]);
            if (!$menuItem->exists) {
                $menuItem->fill([
            ...
            $menuItem = MenuItem::firstOrNew([
                'menu_id' => $menu->id,
                'title'   => 'fa-twitter',
                'url'     => 'https://twitter.com/king_wanyama',
                'route'   => null,
            ]);
            if (!$menuItem->exists) {
                $menuItem->fill([
